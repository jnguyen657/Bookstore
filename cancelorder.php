...
<style>
body {background-image: linear-gradient(to right, #d9d9d9 , #2d2f31); font-family : "Open Sans", sans-serif;}
...
$Clientname = $_SESSION['session_username'];
  ...
  $sql = "UPDATE BookstoreUsers SET customerOrder=' ' WHERE username='$_SESSION[session_username]'";
  ...
  {
    echo '<script>alert("There was a problem with cancelling your order.")</script>';
  }
